...
import { MapPin, Phone, Home, ArrowRight, Calendar, Heart, Star, MessageCircle } from 'react-feather';
        ...
        >
          ...
          >
            <motion.div
              ...
              className="mb-6"
            >
              <span className="text-5xl md:text-7xl font-script text-gold-dark drop-shadow-sm block mb-2">
                Welcome, {guestName}!
              </span>
            </motion.div>
  ...
  return (
    <div className="absolute inset-0 overflow-hidden pointer-events-none">
      {[...Array(25)].map((_, i) => (
        <motion.div
          key={i}
          className="absolute w-2 h-2 rounded-full bg-gold-dark/20"
          style={{
            top: `${Math.random() * 100}%`,
            left: `${Math.random() * 100}%`,
          }}
...
export default function InvitePage() {
  ...
  return (
    <>
      {showSplash && <SplashScreen onComplete={() => setShowSplash(false)} guestName={inviteData?.name || 'Guest'} />}
          ...
          <section className="relative py-20 bg-sand-light overflow-hidden">
            ...
            <div className="relative z-10 max-w-2xl mx-auto px-4">
              ...
              <ScrollSection variant="scaleUp" delay={0.2}>
                <div className="bg-white rounded-2xl shadow-lg border border-gold-light p-6">
