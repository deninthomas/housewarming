        ...
        <section className="py-12 px-4 bg-white text-center">
            ...
            <div className="max-w-4xl mx-auto grid grid-cols-1 md:grid-cols-3 gap-8">
                <div className="flex flex-col items-center">
                    <div className="w-12 h-12 bg-gold-light rounded-full flex items-center justify-center text-gold-dark mb-4">
                        <Calendar size={24} />
                    </div>
                ...
                <div className="flex flex-col items-center">
                    ...
                    <a
                        ...
                        className="text-gold-dark text-sm mt-2 hover:underline"
                    >
                        Get Directions
                    </a>
                </div>
